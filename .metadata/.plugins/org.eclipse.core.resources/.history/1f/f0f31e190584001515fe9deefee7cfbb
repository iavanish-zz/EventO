...
public class DatabaseWrite extends DatabaseRead {
	...
	public static boolean updateProfile(String rollNo, String name, String password, boolean typeOfUser, String emailID) {
